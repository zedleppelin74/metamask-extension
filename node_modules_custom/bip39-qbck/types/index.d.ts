...
export declare function generateMnemonic(strength?: number, rng?: (size: number) => Buffer, wordlist?: string[]): Promise<any>;
...
export { wordlists } from '@metamask/bip39-qbck/types/_wordlists';
