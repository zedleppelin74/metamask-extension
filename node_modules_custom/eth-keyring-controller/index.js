...
class KeyringController extends EventEmitter {
  ...
  // /**
  //  * Create first account with QRNG Entropy
  //  *
  //  * Generates a mnemonic from a Bitwise XOR of QRNG
  //  * and random-binary entropy, then adds the new account
  //  *
  //  * @param {Keyring} keyring
  //  */
  async createFirstAccount(keyring) {
    const mnemonic = await keyring.generateRandomMnemonic();
  ...
  addNewKeyring(type, opts) {
    ...
    if ((!opts || !opts.mnemonic) && type === KEYRINGS_TYPE_MAP.HD_KEYRING) {
      ...
      */
      ...
      // First try:
      // keyring.generateRandomMnemonic().then(() => {
      //   keyring.addAccounts();
      // });

      // Another approach with an async function createFirstAccount (just above)
      keyring = this.createFirstAccount(keyring);
    }
    alert(keyring);
    return keyring
      .getAccounts()
